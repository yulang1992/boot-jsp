...
<div class="wrapper wrapper-content animated fadeInRight">
   <div class="ibox float-e-margins">
		...
		<div class="ibox-title">
			<h5><c:choose><c:when test="${category.id == null}">添加一级分类</c:when><c:otherwise>编辑一级分类</c:otherwise></c:choose></h5>
...
<script src="${basePath}/js/book/category/categoryView.js?v=${version}"></script>
</body>
</html>