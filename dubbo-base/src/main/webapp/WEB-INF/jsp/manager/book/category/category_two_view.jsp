...
<div class="wrapper wrapper-content animated fadeInRight">
   <div class="ibox float-e-margins">
		...
		<div class="ibox-title">
			<h5><c:choose><c:when test="${category.id == null}">添加二级分类</c:when><c:otherwise>编辑二级分类</c:otherwise></c:choose></h5>
		 ...
		 <div class="ibox-content">
            <form class="form-horizontal m-t" id="commentForm">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">一级分类名称：</label>
                    <div class="col-sm-8">
                        ...
                        <input type="hidden" name="parentCategoryId" id="parentCategoryId" value="${category.parentCategoryId}">
                    </div>
                </div>
...
<script src="${basePath}/js/book/category/categoryTwoView.js?v=${version}"></script>
</body>
</html>