               ...
               <div class="col-sm-12">
				...
				<div class="row form-group">
					<div class="col-sm-9">
						...
						<button type="button" class="btn btn-danger" id="shangji"><i class="fa fa-close"></i> 返回二级</button>
					</div>
					<div class="col-sm-3">								
						<div class="input-group">
							<input type="text"class="input-sm form-control" name="keyWord" id="keyWord" value="${keyWord }" placeholder="搜索三级分类名称" name="q">
				...
				<input id="categoryTwoId" value="${categoryTwoId}"  type="hidden"  >
				<input id="superCategoryId" value="${superCategoryId}"  type="hidden"  >  
				<div id="pager"></div>
...
<script src="${basePath}/js/book/category/categoryThreeList.js?v=${version}"></script>
</body>
</html>