               ...
               <div class="col-sm-12">
				...
				<div class="row form-group">
					<div class="col-sm-5">
					    ...
					    <button type="button" class="btn btn-primary" id="enabled"><i class="fa fa-check"></i> 上架</button>
						<button type="button" class="btn btn-danger" id="disable"><i class="fa fa-close"></i> 下架</button>
						<button type="button" class="btn btn-warning" id="load"><i class="fa fa-download"></i> 下载资源</button>
					</div>
...
<script src="${basePath}/js/book/book/bookList.js?v=${version}"></script>
</body>
</html>