				...
				<div class="row form-group">
					...
					<div class="col-sm-3">								
						<div class="input-group">
							<input type="text"class="input-sm form-control" name="keyWord" id="keyWord" value="${keyWord }" placeholder="搜索分页名称" name="q">
...
<script src="${basePath}/js/book/category/categoryList.js?v=${version}"></script>
</body>
</html>