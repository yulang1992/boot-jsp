		...
		<!-- 表格开始 -->
           ...
           <div class="row row-lg">
               <div class="col-sm-12">
				...
				<input type="hidden" id="colNames" name="colNames" value="${colNames}">
				<input type="hidden" id="JqGridColModel" name="JqGridColModel" value="${JqGridColModel}">
				<div id="pager"></div>
...
<script src="${basePath}/js/content/contentDetailList.js?v=${version}"></script>
</body>
</html>