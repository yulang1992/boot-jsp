				...
				<div class="row form-group">
					...
					<div class="col-sm-2">
	                    <select class="form-control m-b" name="account" id="account" >
	                    	<option>选择所属分组</option>
	                        <option value="PC组">PC组</option>
					...
					<div class="col-sm-3">								
						<div class="input-group">
							<input class="input-sm form-control" type="text" name="keyWord" id="keyWord" value="${keyWord }" placeholder="搜索内容名称" name="q">
...
<script src="${basePath}/js/content/contentDefineList.js?v=${version}"></script>
</body>
</html>