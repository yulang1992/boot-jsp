				...
				<div class="row form-group">
					...
					<div class="col-sm-3">								
						<div class="input-group">
							<input type="text"class="input-sm form-control" name="keyWord" id="keyWord" value="${keyWord }" placeholder="搜索公告名称" name="q">
...
<script src="${basePath}/js/content/notice/noticeList.js?v=${version}"></script>
</body>
</html>