   ...
   <div class="ibox float-e-margins">
		...
		<!-- 表格开始 -->
           ...
           <div class="row row-lg">
               ...
               <div class="col-sm-6">
               	<div class="wrapper wrapper-content animated fadeInRight">
				   <div id="chartBookCategeView" align="center" style="height:430px;">The chart will appear within this DIV.</div>
			   </div>
               </div>
           </div>
       	</div>
...
<script src="${basePath}/js/report/reportList.js?v=${version}"></script>
