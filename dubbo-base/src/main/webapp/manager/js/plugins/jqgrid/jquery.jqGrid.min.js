                ...
                var
                    x, y = ["shiftKey", "altKey", "ctrlKey"], z = function (a, b) {
                        ...
                        if (a) {
                            ...
                            d.p.page = z($.jgrid.getAccessor(a, g.page), d.p.page), d.p.lastpage = z($.jgrid.getAccessor(a, g.total), 1), d.p.records = z($.jgrid.getAccessor(a, g.records)),d.p.totalSum = z($.jgrid.getAccessor(a, g.totalSum)), d.p.userData = $.jgrid.getAccessor(a, g.userdata) || {}, K && (r = $.jgrid.getMethod("addSubGridCell")), v = d.p.keyName === !1 ? $.isFunction(g.id) ? g.id.call(d, a) : g.id : d.p.keyName, u = $.jgrid.getAccessor(a, g.root), null == u && $.isArray(a) && (u = a), u || (u = []), t = u.length, o = 0, t > 0 && d.p.page <= 0 && (d.p.page = 1);
                            var
