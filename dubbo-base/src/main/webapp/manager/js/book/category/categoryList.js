...
function loadData() {
	var options = {
			...
			loadTableUrl: basePath + "category/getCategoryList.do",
			pager:"#pager"
	};
...
//查看下级
function xiaji(e){
	document.location.href = basePath + "category/initCategoryTwo.do?categoryId="+e ;	
}
 ...
 */
$("#add").click(function(){
	document.location.href = basePath + "category/viewCategory.do";
});
...
$("#edit").click(function(){
	...
	if(selectRow.length > 1){
		...
		document.location.href = basePath + "category/viewCategory.do?id=" + selectRow[0];
	}else {
