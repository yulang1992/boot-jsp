...
function loadData() {
	...
	var options = {
			...
			loadTableUrl: basePath + "category/getCategoryThreeList.do?categoryTwoId="+categoryTwoId ,
			pager:"#pager"
	};
	...
	var colNames = ['ID','三级分类名称','二级分类名称','是否启用'];
	var JqGridColModel=[
						...
						{name:'parentCategoryName', index:'parentCategoryName', width:320, align:'left', sorttype:'string', sortable:false},
						{name:'isEnable', index:'isEnable', width:300, align:'left', formatter:formatIsEnable, sortable:false}
...
$("#add").click(function(){
	...
	document.location.href = basePath + "category/viewThreeCategory.do?categoryTwoId="+categoryTwoId+"&superCategoryId="+superCategoryId;
});
...
$("#shangji").click(function(){
	var superCategoryId = $("#superCategoryId").val();
	document.location.href = basePath + "category/initCategoryTwo.do?categoryId="+superCategoryId;
});
...
$("#edit").click(function(){
	...
	if(selectRow.length > 1){
		...
		document.location.href = basePath + "category/viewThreeCategory.do?id=" + selectRow[0]+"&categoryTwoId="+categoryTwoId+"&superCategoryId="+superCategoryId;
	}else {
